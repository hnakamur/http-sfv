...
TEST_CASE("skip_parameters", "[skip][parameters]")
{
    ...
    SECTION("invalid key")
    {
        test_skip_parameters_ng(";é=?0");
    }
    SECTION("invalid value")
    {
        test_skip_parameters_ng(";foo=é");
    }
}
...
TEST_CASE("skip_inner_list", "[skip][inner_list]")
{
    ...
    SECTION("ng case 1")
    {
        test_skip_inner_list_ng("(\"foo\";a;b=1936 bar;y=:AQMBAg==:;é);d=18.71");
    }
    SECTION("ng case 2")
    {
        test_skip_inner_list_ng("(\"foo\";a;b=1936 bar;y=:AQMBAg==:);d=18.71;é");
    }
    SECTION("no input")
    {
