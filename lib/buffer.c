...
hsfv_err_t
htsv_buffer_alloc_bytes(hsfv_allocator_t *allocator, hsfv_buffer_t *buf, size_t capacity)
{
...
hsfv_err_t
htsv_buffer_realloc_bytes(hsfv_allocator_t *allocator, hsfv_buffer_t *buf, size_t capacity)
{
...
void
htsv_buffer_free_bytes(hsfv_allocator_t *allocator, hsfv_buffer_t *buf)
{
...
hsfv_err_t
htsv_buffer_ensure_unused_bytes(hsfv_allocator_t *allocator, hsfv_buffer_t *buf, size_t len)
{
    size_t new_capacity;
...
hsfv_err_t
htsv_buffer_ensure_append_byte(hsfv_allocator_t *allocator, hsfv_buffer_t *buf, const char src)
{
    hsfv_err_t err;
...
hsfv_err_t
htsv_buffer_ensure_append_bytes(hsfv_allocator_t *allocator, hsfv_buffer_t *buf, const char *src, size_t len)
{
    hsfv_err_t err;
